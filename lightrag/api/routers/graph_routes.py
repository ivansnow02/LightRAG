...
from ..utils_api import get_rag_for_user
...
def create_graph_routes_with_multi_user():
    ...
    @router.get("/graph/label/list/{course_id}")
    ...
    @router.get("/graph/entity/exists/{course_id}")
    async def check_entity_exists(
            name: str = Query(..., description="Entity name to check"),
            rag: LightRAG = Depends(get_rag_for_user)
    ):
    ...
    @router.post("/graph/entity/edit/{course_id}")
    ...
    @router.post("/graph/relation/edit/{course_id}")
